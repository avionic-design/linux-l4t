/*
 * arch/arm/mach-tegra/board-medcom-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config medcom_drive_pinmux[] = {
        DEFAULT_DRIVE(SDIO1),
	DEFAULT_DRIVE(VI1),
	DEFAULT_DRIVE(VI2),
};

static __initdata struct tegra_pingroup_config medcom_pinmux[] = {
...
static struct tegra_gpio_table gpio_table[] = {
	...
	{ .gpio = TEGRA_GPIO_CPLD_IRQ,		.enable = true	},
};

void __init medcom_pinmux_init(void)
{
	tegra_pinmux_config_table(medcom_pinmux, ARRAY_SIZE(medcom_pinmux));
	tegra_drive_pinmux_config_table(medcom_drive_pinmux,
                                        ARRAY_SIZE(medcom_drive_pinmux));
