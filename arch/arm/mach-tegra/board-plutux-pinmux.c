/*
 * arch/arm/mach-tegra/board-plutux-pinmux.c
 *
...
static struct tegra_drive_pingroup_config plutux_drive_pinmux[] __initdata = {
	DEFAULT_DRIVE(SDIO1),
};

static struct tegra_pingroup_config plutux_pinmux[] __initdata = {
...
void __init plutux_pinmux_init(void)
{
	tegra_pinmux_config_table(plutux_pinmux,
				  ARRAY_SIZE(plutux_pinmux));
	tegra_drive_pinmux_config_table(plutux_drive_pinmux,
					ARRAY_SIZE(plutux_drive_pinmux));
