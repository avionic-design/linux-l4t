...
struct clk_duplicate tegra_clk_duplicates[] = {
	...
	CLK_DUPLICATE("vi", "vi.0", "vi"),
	CLK_DUPLICATE("csi", "vi.0", "csi"),
	CLK_DUPLICATE("csus", "vi.0", "csus"),
	CLK_DUPLICATE("cilab", "vi.0", "cilab"),
	CLK_DUPLICATE("cilcd", "vi.0", "cilcd"),
	CLK_DUPLICATE("cile", "vi.0", "cile"),
