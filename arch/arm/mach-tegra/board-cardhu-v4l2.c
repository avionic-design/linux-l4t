...
static struct regulator *cardhu_supply_csi = NULL;
...
static int cardhu_camera_enable(struct nvhost_device *ndev)
{
	return cardhu_ov5640_power_on();
}

static void cardhu_camera_disable(struct nvhost_device *ndev)
{
...
static struct soc_camera_link ov5640_iclink = {
	...
	.board_info	= cardhu_i2c8_board_info,
	.module_name	= "ov5640",
};
...
static struct tegra_camera_platform_data cardhu_camera_platform_data = {
	.enable_camera		= cardhu_camera_enable,
	.disable_camera		= cardhu_camera_disable,
	.flip_v			= 0,
	.flip_h			= 0,
...
int __init cardhu_sensors_init(void)
{
	...
	t30_get_tegra_vi01_device()->dev.platform_data = &cardhu_camera_platform_data;
