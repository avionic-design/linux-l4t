...
static const struct tegra_formats tegra_formats[] = {
	...
	/* Bayer with IR */
	TEGRA_FORMATS_RAW(BGIR),
	TEGRA_FORMATS_RAW(GBRI),
	TEGRA_FORMATS_RAW(IRBG),
	TEGRA_FORMATS_RAW(RIGB),
...
static int mbus_format_to_csi_data_type(enum v4l2_mbus_pixelcode mbus)
{
	...
	case V4L2_MBUS_FMT_SGBRI8_1X8:
	case V4L2_MBUS_FMT_SIRBG8_1X8:
	case V4L2_MBUS_FMT_SRIGB8_1X8:
	...
	case V4L2_MBUS_FMT_SGBRI10_1X10:
	case V4L2_MBUS_FMT_SIRBG10_1X10:
	case V4L2_MBUS_FMT_SRIGB10_1X10:
	...
	case V4L2_MBUS_FMT_SBGIR12_1X12:
	case V4L2_MBUS_FMT_SGBRI12_1X12:
	case V4L2_MBUS_FMT_SIRBG12_1X12:
	case V4L2_MBUS_FMT_SRIGB12_1X12:
